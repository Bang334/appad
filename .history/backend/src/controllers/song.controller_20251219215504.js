...
class SongController {
  ...
  static async play(req, res) {
    try {
      ...
      // Only update if song doesn't have duration
      if (req.body.actual_duration && (!song.duration || song.duration === 0)) {
        ...
        if (actualDurationSeconds > 0) {
          try {
            ...
            console.log(`✅ [BACKEND] Auto-updated song duration: ${id} -> ${actualDurationSeconds}s`);
